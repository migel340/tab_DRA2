...
class ActivityServiceTest {
    ...
    void updateAssignedStatusAllowsOwnerToChangeStatus() {
        ...
        assertThat(response.getPersonelId()).isEqualTo(200);
    }
    ...
    void updateAssignedStatusRejectsNonAssignedUser() {
        ...
        assertThrows(org.springframework.security.access.AccessDeniedException.class, () -> activityService.updateAssignedStatus(1L, dto));
    }
